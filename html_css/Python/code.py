...
if 500 < price <= 1000:
    print(f"Стоимость покупки без скидки: {price} руб.\nСкидка 3%\nСтоимость покупки со скидки: {price * 0.97} руб.")
elif price > 1000:
    print(f"Стоимость покупки без скидки: {price} руб.\nСкидка 5%\nСтоимость покупки со скидки: {price * 0.95} руб.")
else:
    print("Скидок нет!", price, "руб.")
